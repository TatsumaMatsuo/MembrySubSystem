...
export default function RiskAssessmentRequestPage() {
  const larkFormUrl = "https://osvn246ak4c.jp.larksuite.com/share/base/form/shrjp16vuarrBUXcabyTAbSguUd?from=navigation";
